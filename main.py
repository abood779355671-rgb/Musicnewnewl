...
@client.on_message(filters.command(["p", "play", "تشغيل", "شغل"], config.PREFIXES) & ~filters.private)
@register
@language
@handle_error
...
@client.on_message(
    filters.command(["radio", "stream", "راديو"], config.PREFIXES) & ~filters.private
)
@register
@language
@handle_error
...
@client.on_message(
    filters.command(["skip", "next", "تخطي"], config.PREFIXES) & ~filters.private
)
@register
@language
@only_admins
...
@client.on_message(filters.command(["m", "mute", "كتم"], config.PREFIXES) & ~filters.private)
@register
@language
@only_admins
@handle_error
...
@client.on_message(
    filters.command(["um", "unmute", "رفع"], config.PREFIXES) & ~filters.private
)
@register
@language
@only_admins
...
@client.on_message(filters.command(["ps", "pause", "ايقاف"], config.PREFIXES) & ~filters.private)
@register
@language
@only_admins
@handle_error
...
@client.on_message(
    filters.command(["rs", "resume", "استمر"], config.PREFIXES) & ~filters.private
)
@register
@language
@only_admins
...
@client.on_message(
    filters.command(["stop", "leave", "اوقف"], config.PREFIXES) & ~filters.private
)
@register
@language
@only_admins
...
@client.on_message(
    filters.command(["list", "queue", "القائمة"], config.PREFIXES) & ~filters.private
)
@register
@language
@handle_error
...
@client.on_message(
    filters.command(["mix", "shuffle", "اخلط"], config.PREFIXES) & ~filters.private
)
@register
@language
@only_admins
...
@client.on_message(
    filters.command(["loop", "repeat", "كرر"], config.PREFIXES) & ~filters.private
)
@register
@language
@only_admins
...
@client.on_message(
    filters.command(["pl", "playlist", "قائمة"], config.PREFIXES) & ~filters.private
)
@register
@language
@handle_error
